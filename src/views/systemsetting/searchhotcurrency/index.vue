<template>
  <div class="app-container">
    ...
    <el-button type="primary" size="mini" icon="el-icon-plus" @click="addConfig">添加搜索热门币对配置</el-button>
    ...
    <el-dialog title="添加搜索热门币对配置" :visible.sync="open" width="500px" :before-close="cancel" :close-on-click-modal="false">
      <el-form
        ref="digform"
        :model="digform"
        :rules="rules"
...
import * as API from '@/api/systemsetting/searchhotcurrency'

export default {
  name: 'Searchhotcurrency',
  data() {
