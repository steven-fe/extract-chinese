<template>
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="12" :span="3">
        <div style="line-height: 36px" class="grid-content bg-purple">{{ '累计拨币:' + sum }}</div>
      </el-col>
    </el-row>
    <!--table-->
    <el-table v-loading="loading" border class="top" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="userValue" label="用户手机" />
      ...
      <el-table-column prop="gtime" label="创建时间" />
    </el-table>
    <!--分页组件-->
    <div class="block top">
      <pagination
