<template>
  <div class="app-container">
    <el-form
      ...
      class="form-grid"
    >
      <el-form-item class="grid-item" :label="$t('financemanager.financialAccount')" label-width="auto" prop="fromUserId">
...
import { assetFromUser, assetToUser, assetTransfer } from '@/api/finance/freecurrency'
      ...
      this.$refs['digform'].validate((valid) => {
        if (valid) {
          this.$confirm(this.$t('financemanager.whetherToTransferToTheAccount'), this.$t('common.prompt'), {
            ...
            assetTransfer(this.digform).then(res => {
              if (res.code === 200) {
                this.$message({
                  type: 'success',
