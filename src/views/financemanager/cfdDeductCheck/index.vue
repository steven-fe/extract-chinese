      ...
      <el-form ref="form" :model="form" label-width="130px">
        <el-row :gutter="10" class="mb8">
          <el-col :span="12">
            ...
            <el-form-item label="划扣金额：" prop="amount">
              <span>{{ form.amount }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="划扣UID：" prop="fromUid">
              <span>{{ form.fromUid }}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item label="划扣备注：" prop="meta">
          <span>{{ form.meta }}</span>
        </el-form-item>
      </el-form>
      <div class="footer">
        <span class="tips">
          ...
          <span
            ...
            style="color: green"
          >通过</span>
          <span v-if="this.form.handleType == 2" style="color: red">驳回</span>并执行这条划扣记录吗？
        </span>
        <div>
          <el-button
            v-if="this.form.handleType == 1"
