<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('dwmanager.cashWithdrawalAmount')" align="center" prop="withAmount">
        <template slot-scope="scope">
          <span>{{ scope.row.withAmount }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('financemanager.theAmountOfCashWithdrawn')" align="center" prop="withCount" />
      <el-table-column :label="$t('financemanager.numberOfSuccessfulStrokes')" align="center" prop="succCount" />
      <el-table-column :label="$t('financemanager.numberOfWithdrawalUsers')" align="center" prop="userCount" />
      <el-table-column :label="$t('financemanager.maximumWithdrawalUserId')" align="center" prop="maxUid" />
    </el-table>
...
import { listDay, exportDay } from '@/api/operate/withdrawday'
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm(this.$t('financemanager.confirmWhetherToExportWithdrawalStatistics'), this.$t('common.alert'), {
