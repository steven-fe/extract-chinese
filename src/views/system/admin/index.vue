      ...
      <!--
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleImport"
              v-hasPermi="['system:admin:import']"
            >导入</el-button>
          </el-col>
          -->
      <el-col :span="1.5">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属部门" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" placeholder="请选择归属部门" clearable/>
            </el-form-item>
          </el-col>
          -->
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="用户性别">
              <el-select v-model="form.sex" :placeholder="$t('common.pleaseChoose')" clearable>
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="岗位">
              <el-select v-model="form.postIds" multiple :placeholder="$t('common.pleaseChoose')" clearable>
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="角色">
              <el-select v-model="form.roleIds" multiple :placeholder="$t('common.pleaseChoose')" clearable>
                <el-option
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + '/coinbull/system/admin/importData'
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
