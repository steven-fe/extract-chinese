<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitDataScope">{{$t('common.sure')}}</el-button>
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.roleName + '"角色吗?', this.$t('common.alert'), {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除角色编号为"' + roleIds + '"的数据项?', this.$t('common.alert'), {
        confirmButtonText: this.$t('common.sure'),
        cancelButtonText: this.$t('common.cancel'),
        type: 'warning'
      }).then(function() {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有角色数据项?', this.$t('common.alert'), {
        confirmButtonText: this.$t('common.sure'),
        cancelButtonText: this.$t('common.cancel'),
        type: 'warning'
      }).then(function() {
